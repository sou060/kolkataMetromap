...
public class KolkataMetroMap
{
    ...
    public static void Create_Metro_Map(KolkataMetroMap kolkataMetroMap)
    {
        kolkataMetroMap.addVertex("Salt Lake Sector V");
        kolkataMetroMap.addVertex("Kolkata International Airport");
        kolkataMetroMap.addVertex("Dum Dum");
        kolkataMetroMap.addVertex("Shyambazar");
        kolkataMetroMap.addVertex("Esplanade");
        kolkataMetroMap.addVertex("Park Street");
        kolkataMetroMap.addVertex("Rabindra Sadan");
        kolkataMetroMap.addVertex("Kalighat");
        kolkataMetroMap.addVertex("Maidan");
        kolkataMetroMap.addVertex("Howrah");
        kolkataMetroMap.addVertex("Sealdah");
        kolkataMetroMap.addVertex("Bidhannagar Road");
        kolkataMetroMap.addVertex("Girish Park");
        kolkataMetroMap.addVertex("Jatin Das Park");
        kolkataMetroMap.addVertex("Kavi Subhash");
        kolkataMetroMap.addVertex("Chandni Chowk");

        kolkataMetroMap.addEdge("Salt Lake Sector V", "Kolkata International Airport", 10);
        kolkataMetroMap.addEdge("Kolkata International Airport", "Dum Dum", 5);
        kolkataMetroMap.addEdge("Dum Dum", "Shyambazar", 6);
        kolkataMetroMap.addEdge("Shyambazar", "Esplanade", 8);
        kolkataMetroMap.addEdge("Esplanade", "Park Street", 3);
        kolkataMetroMap.addEdge("Park Street", "Rabindra Sadan", 7);
        kolkataMetroMap.addEdge("Rabindra Sadan", "Kalighat", 4);
        kolkataMetroMap.addEdge("Kalighat", "Maidan", 6);
        kolkataMetroMap.addEdge("Maidan", "Howrah", 5);
        kolkataMetroMap.addEdge("Howrah", "Sealdah", 7);
        kolkataMetroMap.addEdge("Sealdah", "Bidhannagar Road", 4);
        kolkataMetroMap.addEdge("Bidhannagar Road", "Girish Park", 6);
        kolkataMetroMap.addEdge("Girish Park", "Jatin Das Park", 3);
        kolkataMetroMap.addEdge("Jatin Das Park", "Kavi Subhash", 8);
        kolkataMetroMap.addEdge("Kavi Subhash", "Chandni Chowk", 5);
    }
    ...
    {
        KolkataMetroMap g = new KolkataMetroMap();
        Create_Metro_Map(g);
